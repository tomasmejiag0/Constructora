                      ...
                      {filteredUsers.map((user, index) => (
                        ...
                        >
                          ...
                          <td className="p-3 text-right space-x-2">
                            <Button variant="ghost" size="icon" className="hover:bg-primary/10 text-primary" disabled={user.email === 'admin@example.com'}>
                              <Edit size={16} />
                            </Button>
                            <Button variant="ghost" size="icon" className="hover:bg-destructive/10 text-destructive" disabled={user.email === 'admin@example.com'}>
                              <Trash2 size={16} />
                            </Button>
                          </td>
                        </motion.tr>
